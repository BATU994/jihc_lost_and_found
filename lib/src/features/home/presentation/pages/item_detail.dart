              ...
              Stack(
                children: [
                  ClipRRect(
                    ...
                    child: Image.network(
                      'http://127.0.0.1:8000${item.item_image}',
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      final currentId = await ProfileInfo().getId();
                      final currentUserId = currentId;
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            SizedBox(width: 12),
                            Text(
                              !item.isLost ? 'THIS IS MINE' : 'I FOUND THIS',
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 18,
                                color: Colors.white,
